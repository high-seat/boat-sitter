...
| Method | Path                                                  | Notes                                                                                                                                                                                                                                                                         |
| ------ | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET    | `/api/applications?sitId=`                            | Applications for one listing; `sort` (`newest`/`experience`/`skillMatch`/`priorSits`), `status`, `experience` (`any`/`meetsMin`/`fivePlus`/`tenPlus`), `page`, `limit` (default 5, max 50). Response: `data`, `accepted`, `total`, `page`, `limit`, `totalPages`, `sitTotal`. |

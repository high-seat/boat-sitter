const en = {
  ...
  "applications.sharePhoneInChatHint": "Share the number from your profile so you can coordinate by phone.",
...
const applicationTranslationsSource: Record<string, Record<string, string>> = {
  ...
  fr: {
    ...
    "applications.sharePhoneInChatHint": "Partagez le numéro de votre profil pour coordonner par téléphone.",
  ...
  "es-ES": {
    ...
    "applications.sharePhoneInChatHint": "Comparte el número de tu perfil para coordinar por teléfono.",
  ...
  it: {
    ...
    "applications.sharePhoneInChatHint": "Condividi il numero del tuo profilo per coordinarvi al telefono.",
    ...
    "applications.systemMessage.phoneShared": "{{name}} ha condiviso il proprio numero di telefono.",
  ...
  de: {
    ...
    "applications.sharePhoneInChatHint": "Teilen Sie die Nummer aus Ihrem Profil, um per Telefon abzustimmen.",
  ...
  nl: {
    ...
    "applications.sharePhoneInChatHint": "Deel het nummer van je profiel zodat jullie telefonisch kunnen afstemmen.",
  ...
  "pt-PT": {
    ...
    "applications.sharePhoneInChatHint": "Partilhe o número do seu perfil para coordenarem por telefone.",
  ...
  el: {
    ...
    "applications.sharePhoneInChatHint": "Κοινοποιήστε τον αριθμό από το προφίλ σας για να συντονιστείτε τηλεφωνικά.",
    ...
    "applications.systemMessage.phoneShared": "Ο χρήστης {{name}} κοινοποίησε τον αριθμό τηλεφώνου.",
  ...
  hr: {
    ...
    "applications.sharePhoneInChatHint": "Podijelite broj s profila kako biste se mogli dogovoriti telefonom.",
  ...
  tr: {
    ...
    "applications.sharePhoneInChatHint": "Telefonla koordinasyon için profilinizdeki numarayı paylaşın.",
  ...
  sv: {
    ...
    "applications.sharePhoneInChatHint": "Dela numret från din profil så att ni kan stämma av per telefon.",
  ...
  nb: {
    ...
    "applications.sharePhoneInChatHint": "Del nummeret fra profilen din slik at dere kan avtale på telefon.",
  ...
  da: {
    ...
    "applications.sharePhoneInChat": "Del telefonnummer",
    "applications.sharePhoneInChatHint": "Del nummeret fra din profil, så I kan koordinere pr. telefon.",
    ...
    "applications.sharePhoneInChatHint": "Jaa profiilisi numero, jotta voitte sopia asioista puhelimitse.",
  ...
  ja: {
    ...
    "applications.sharePhoneInChatHint": "プロフィールの番号を共有して電話で連絡できるようにします。",
    "applications.sharePhoneInChatConfirmTitle": "電話番号を共有しますか？",
    "applications.sharePhoneInChatConfirmText": "これにより、この会話で {{phone}} が {{name}} に送信されます。相手は電話やメッセージで連絡できます。",

...
INSERT INTO sits (
  ...
  ('solstice', 'solstice-boat', '12 Sep – 4 Oct', '2026-09-12', '22 nights', 'Lefkada', 'Greece', 'Berth B12, Lefkas Marina, Lefkada 311 00, Greece', 38.7066, 20.7019, '["Check bilges and battery monitor each morning","Run engine and watermaker weekly","Adjust lines and fenders after strong weather","Flush heads and air cabins regularly"]', '["5+ years sailing","Diesel basics","Liveaboard experience"]', 5, '["Liveaboard"]', '[]', '["Diesel troubleshooting","Mooring & lines"]', 2, 'Pip, a sea-loving terrier', 1, 1, 'liveaboard'),
  ...
  ('saltwood', 'saltwood-boat', '1 Apr – 15 Apr', '2027-04-01', '14 nights', 'Falmouth', 'United Kingdom', NULL, 50.1533, -5.0656, '["Check bilge twice daily — she takes up slowly","Inspect topside seams after dry spells","Tend lines on spring tides","Keep her covered and aired"]', '[]', 0, '[]', '[]', '[]', 2, NULL, 0, 1, 'liveaboard'),
